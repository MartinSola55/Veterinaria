...
<html>
	...
	<main>
		<h1 class="text-center mt-5">Practicas</h1>
		
		
			<div id="tabla-practica" class="container body-content mt-5">
			</div>
			<hr />
			    ...
			    <div class="modal-dialog modal-dialog-centered">
			        <div class="modal-content">
			            ...
			            <div class="modal-body contenedor-modal align-items-center">
			                ...
			                <label id="campo1" class="mb-3">Precio: </label>
			                <input id="txtPrecio" type="number" min="0" oninput="validity.valid||(value='');" class="form-control limpiarCampo habilitarCampo deshabilitarCampo required mb-3" ></input>
			            </div>
