...
<html>
	...
	<main>
		<h1 class="text-center mt-5">Razas</h1>
		

			<div id="tabla-razas" class="container body-content mt-5">
			</div>
			<hr />
			    ...
			    <div class="modal-dialog modal-dialog-centered">
			        <div class="modal-content">
			            ...
			            <div class="modal-body contenedor-modal align-items-center">
			                ...
			                <label id="campo1" class="mb-3">Especie: </label>
			                <select id="comboEspecies" class="form-control limpiarCampo habilitarCampo deshabilitarCampo required mb-3" ></select>
